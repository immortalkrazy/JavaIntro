...
public class Asgmt_07a {
      ...
      public static void main(String[] args) throws Exception {
            ...
            String path = "C:\\Users\\faisa\\OneDrive\\Documents" + "\\NetBeansProjects\\InputTextFiles\\asgmt07a";
            ...
            myOut.println("Hello to File");
            for (int i = 0; i < car.length; i++) {
                  myOut.println(car[i] + "\t" + inv[i]);
            }
            ...
            // this a new thing i did in 3115
            /*
             * myOut.println ("Hello to File"); for (int i = 0; i < car.length; i++){
             * myOut.println(car[i]+ "\t" +inv[i]); }
             */
            myOut.close();
            flC.close();
